    ...
    chat_completion = client.chat.completions.create(
        messages=[
            ...
            },
            {
                "role": "user",
                "content": (
                    "Придумай шутки на основе новостей. Ответь самими шутками и только ними, никакой другой информации. "
                    "Раздели шутки тремя хэштегами (###). Никак их не помечай кроме этого. "
                    "новости должны быть в исходном порядке. Сами новости: \n"
                    + "\n".join(news)
                ),
            }
        ],
